...
public class CmsTaskApiAct {
	...
	private void init() {
		taskClasss.put("com.jeecms.cms.task.job.IndexStaticJob", "com.jeecms.cms.task.job.IndexStaticJob");
		taskClasss.put("com.jeecms.cms.task.job.ChannelStaticJob", "com.jeecms.cms.task.job.ChannelStaticJob");
		taskClasss.put("com.jeecms.cms.task.job.ContentStaticJob", "com.jeecms.cms.task.job.ContentStaticJob");
		taskClasss.put("com.jeecms.cms.task.job.AcquisiteJob", "com.jeecms.cms.task.job.AcquisiteJob");
		taskClasss.put("com.jeecms.cms.task.job.DistributeJob", "com.jeecms.cms.task.job.DistributeJob");
	}
	...
	private void startTask(CmsTask task,String taskCode) throws ParseException, SchedulerException, ClassNotFoundException{
		...
		if(cronExpress.indexOf("null")==-1 && taskClasss.get(task.getJobClass())!=null){
			...
			jobDetailFactoryBean.setJobClass(getClassByTask(taskClasss.get(task.getJobClass())));
			//任务需要参数attr属性 
