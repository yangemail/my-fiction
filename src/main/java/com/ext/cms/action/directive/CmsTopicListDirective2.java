...
import com.jeecms.cms.action.directive.CmsTopicListDirective;
 ...
 * 专题列表标签
 */
public class CmsTopicListDirective2  implements TemplateDirectiveModel {
	
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "topic_list2";
	...
	/**
	 * 输入参数，排列顺序。0：按优先级降序；1：按优先级升序。默认降序。
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<CmsTopic> list = cmsTopicMng.getListForTag(getChannelId(params),
				getRecommend(params), getDesc(params), 0,FrontUtils.getCount(params));
	...
	@Autowired
	private CmsTopicMng2 cmsTopicMng;
}
