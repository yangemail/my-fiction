...
function get_down_url(url,durl,name){
    ...
    // }else{
		...
		// href="/login.php?jumpurl='+url+'">'+name+'</a>');
    // }
}
...
function a(){
	...
	// src="/ab_res/pc/fixed/fixed.js?type=300&flag=0&res_root=/ab_res&ab_key=k12"></script>');

    // document.writeln("</span>");
    // document.writeln("<span>");
    // document.writeln('<script
	// src="/ab_res/pc/fixed/fixed.js?type=300&flag=1&res_root=/ab_res&ab_key=k12"></script>');

    // document.writeln("</span>");
    // document.writeln("<span>");
    // document.writeln('<script
	// src="/ab_res/pc/fixed/fixed.js?type=300&flag=2&res_root=/ab_res&ab_key=k12"></script>');
...
function top_ad(){
    ...
    // document.writeln('<script
	// src="/ab_res/pc/fixed/fixed.js?type=960&res_root=/ab_res&ab_key=k12"></script>');
    // document.writeln("</div>");
}
// 通栏960:90底部
function bot_ad(){
// document.writeln("<div style=\"margin:10px 5px;\">");
// document.writeln("<script type=\"text/javascript\">/*mianhuatang通栏960:90底部*/
// var cpro_id = \"u2764994\";</script><script
// src=\"http://cpro.baidustatic.com/cpro/ui/c.js\"
